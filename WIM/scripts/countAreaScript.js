...
let bInput = "<div class = 'col-lg'><input id = 'b' placeholder = 'b'></div>";
let hInput = "<div class = 'col-lg'><input id = 'h' placeholder = 'h'></div>";
let rInput = "<div class = 'col-lg'><input id = 'r' placeholder = 'r'></div>";
