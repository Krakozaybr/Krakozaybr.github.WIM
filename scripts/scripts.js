...
code[7] = "<div class = 'content-title'>"
            +"<h2>Начальная</h2>"
          +"</div>"
          +"<p class = 'main-text'>Приветствую тебя, Пользователь! Это вторая переработанная версия ВИМа.<br><br>Слева (или сверху) есть кнопки, при нажатии на которые появится соответствующий функционал. Если вы используете телефон, для исключения дефектов и большего удобства переключитесь в горизонтальный режим.<br><br>Приятного пользования!</p>"
